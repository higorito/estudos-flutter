...
mixin _$ProdutoStore on _ProdutoStore, Store {
  ...
  @override
  String get valor => (_$valorComputed ??=
          Computed<String>(() => super.valor, name: '_ProdutoStore.valor'))
      .value;
  ...
  @override
  dynamic attNome({required String nome}) {
    final _$actionInfo = _$_ProdutoStoreActionController.startAction(
        name: '_ProdutoStore.attNome');
    try {
      return super.attNome(nome: nome);
    } finally {
  ...
  @override
  dynamic attDescricao({required String descricao}) {
    final _$actionInfo = _$_ProdutoStoreActionController.startAction(
        name: '_ProdutoStore.attDescricao');
    try {
      return super.attDescricao(descricao: descricao);
    } finally {
      _$_ProdutoStoreActionController.endAction(_$actionInfo);
    }
  }
  ...
  @override
  dynamic attValor({required String valor}) {
    final _$actionInfo = _$_ProdutoStoreActionController.startAction(
        name: '_ProdutoStore.attValor');
    try {
      return super.attValor(valor: valor);
    } finally {
      _$_ProdutoStoreActionController.endAction(_$actionInfo);
    }
  }
